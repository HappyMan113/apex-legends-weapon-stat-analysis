...
|---------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Compare       | Tells you the best loadout(s) matching the given expression, in terms of the highest expected mean DPS.                                                                               | `COMPARE <weapon> [SIDEARM <weapon>] [<<<weapon>\|SAME MAIN> [SIDEARM <weapon>]>\|REVERSE]...` | <ul><li>"Compare wingman with peacekeeper"</li><li>"Compare RE-45 with purple mag with P2020 with level 1 light mag with hammerpoint"</li><li>"Compare flatline level 2 mag no stock sidearm RE-45 same main sidearm Wingman"</li><li>"Compare R-99 with level 2 stock with Flatline with level 1 extended heavy magazine"</li><li>"Compare R-301 level 2 sidearm wingman boosted loader Flatline with no mag purple standard stock"</li><li>"Compare peacekeeper single shot sidearm RE-45 with peacekeeper sidearm RE-45"</li><li>"Compare peacekeeper sidearm R-99 with the reverse"</li><li>"Compare volt"</li></ul> | 
| Best Loadouts | Tells you the best loadout(s) available among all available, or the best loadouts among all fully-kitted loadouts containing at least one of given weapons and/or classes of weapons. | `BEST [number] [<weapon>\|<weapon class>]... <LOADOUT\|LOADOUTS>`                              | <ul><li>"Best loadout"</li><li>"Best 3 loadouts"</li><li>"Best 3 sniper loadouts"</li><li>"Best shotgun loadout"</li><li>"Best Flatline loadout"</li><li>"Best Marksman or Sniper loadout"</li><li>"Best Flatline or Prowler loadouts"</li><li>"Best Flatline with blue mag, RE-45 with level 1 mag with hammerpoint, or Prowler with level 2 mag loadouts"</li></ul>                                                                                                                                                                                                                                                    | 

Argument syntaxes are further broken down as follows:

| Argument         | Syntax                                                                                                           |
|------------------|------------------------------------------------------------------------------------------------------------------|
| `<weapon>`       | `[BASE\|LEVEL <number>\|FULLY KITTED] <weapon name> [<<LEVEL <level>\|NO> <attachment name>>\|<hop-up name>]...` |
| `<weapon class>` | `<AR\|LMG\|MARKSMAN\|PISTOL\|SHOTGUN\|SMG\|SNIPER>`                                                              |
