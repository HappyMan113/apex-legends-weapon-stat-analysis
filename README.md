...
| Best Loadout(s)   | Tells you the best loadout(s) available among all available fully-kitted weapons.                                                                                                              | `best [number] loadout(s)`                                                                                                                                                             | <ul><li>"Best loadout"</li><li>"Best 3 loadouts"</li></ul>                                                                                                                                                                                                                                                                                                                                                                                           | 
