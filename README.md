...
| Configure Default | Configure default sidearm setting. Default for sidearm is initially none. Name of sidearm may be ommitted to get the current default. | <ul><li>`CONFIGURE SIDEARM weapon [<<LEVEL <level> <attachment>>\|<hop-up>>>...]`</li></ul>                                                                                                                                                                                                                                                                                                                                                                            | <ul><li>"Configure sidearm Wingman"</li><li>"Configure default sidearm RE-45 with hammerpoint with blue mag"</li><li>"Configure reloads false"</li></ul>                                                                                                                                                                                                                                                                                                                                                                                                                                     | 
